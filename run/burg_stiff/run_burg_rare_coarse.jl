...
source_terms_burg_mu_6 = SourceTermBurgNonLinear(mu())
...
problem = Problem(domain, initial_value, boundary_value,
                  ...
                  source_terms = source_terms_burg_mu_6)
...
grid_x = LinRange(xf[1], xf[end], 1000)
plot!(grid_x, exact_t.(grid_x), label = "Exact Solution", lw = 2)
