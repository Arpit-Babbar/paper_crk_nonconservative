...
vxLUT.RGBPoints = [-23.326033495210698, 0.231373, 0.298039, 0.752941, -8.206768598029157e-13, 0.865003, 0.865003, 0.865003, 23.326033495209057, 0.705882, 0.0156863, 0.14902]
vxLUT.ScalarRangeInitialized = 1.0

# get opacity transfer function/opacity map for 'vx'
vxPWF = GetOpacityTransferFunction('vx')
vxPWF.Points = [-23.326033495210698, 0.0, 0.5, 0.0, 23.326033495209057, 1.0, 0.5, 0.0]
...
vxLUTColorBar.Position = [0.05159090909090894, 0.14]
vxLUTColorBar.Title = ''
vxLUTColorBar.ComponentTitle = ''
vxLUTColorBar.TitleColor = [0.0, 0.0, 0.0]
vxLUTColorBar.TitleFontSize = 28
vxLUTColorBar.LabelColor = [0.0, 0.0, 0.0]
vxLUTColorBar.LabelFontSize = 28
vxLUTColorBar.RangeLabelFormat = '%2.1f'
vxLUTColorBar.ScalarBarLength = 0.9009090909090902
...
# Same color bar for v1 and v2
ExportView('./tmp_2d_color_bar_v1_final.pdf', view=myview)
ExportView('./tmp_2d_color_bar_v2_final.pdf', view=myview)
