...
resultLUT.RGBPoints = [-23.326033495210698, 0.23137254902, 0.298039215686, 0.752941176471, -8.206768598029157e-13, 0.865, 0.865, 0.865, 23.326033495209057, 0.705882352941, 0.0156862745098, 0.149019607843]
resultLUT.ScalarRangeInitialized = 1.0

# get opacity transfer function/opacity map for 'Result'
resultPWF = GetOpacityTransferFunction('Result')
resultPWF.Points = [-23.326033495210698, 0.0, 0.5, 0.0, 23.326033495209057, 1.0, 0.5, 0.0]
...
filename = f'./tmp_2d_vx_final_nx{nx}.png'
