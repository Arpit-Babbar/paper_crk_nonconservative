...
resultLUT.RGBPoints = [-3.999932662993491, 0.23137254902, 0.298039215686, 0.752941176471, 0.0, 0.865, 0.865, 0.865, 3.999932662993491, 0.705882352941, 0.0156862745098, 0.149019607843]
resultLUT.ScalarRangeInitialized = 1.0
resultLUT.VectorMode = 'Component'

# get opacity transfer function/opacity map for 'Result'
resultPWF = GetOpacityTransferFunction('Result')
resultPWF.Points = [-3.999932662993491, 0.0, 0.5, 0.0, 3.999932662993491, 1.0, 0.5, 0.0]
...
SaveScreenshot('./tmp_2d_vx_initial.png', myview,
